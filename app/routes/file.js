...
router.get('/upload/silver', (req, res) => {
  res.send(`
    <!DOCTYPE html>
    <html>
    <head>
      <title>Partner Media Upload</title>
      <style>
    ...
    <body>
      <div class="card">
        <h1>Partner Media Upload</h1>
        <p>Only <code>image/jpeg</code> and <code>image/png</code> should be accepted. The backend trusts MIME metadata too much.</p>
        <form action="/upload/silver" method="post" enctype="multipart/form-data">
      ...
      <div class="card">
        ...
        <pre>curl -F "file=@shell.php;type=image/jpeg" http://HOST/upload/silver</pre>
      </div>
    </body>
    </html>
  `);
